...
text_data_label.iloc[:int(datalen*0.7)].to_csv('londonreview_train.csv',index=False)
text_data_label.iloc[int(datalen*0.7)+1:].to_csv('londonreview_eval.csv',index=False)
