...
class text_classifier():
    ...
    def get_feature_columns(self):
        text = tf.feature_column.categorical_column_with_hash_bucket('text', 1e6)
        text = tf.feature_column.embedding_column(text, 32)
...
if __name__ == '__main__':
    ...
    tfmodel.load_data('../data/londonreview_train.csv', [tf.string, tf.float32], eval_path='../data/londonreview_eval.csv', header=True,
